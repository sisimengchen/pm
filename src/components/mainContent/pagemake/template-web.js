...
const template = {};
!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof window.define && window.define.amd ? window.define([], t) : "object" == typeof exports ? exports.template = t() : e.template = t()
}(template, function() {
    return function(e) {
        function t(r) {
            if (n[r])
        ...
        var i = n(9)
          ...
          , x = function() {
            function e(t) {
                ...
                n[l] = "function(){var a=arguments,s;if(typeof a[0]==='function'){return " + d + "(a[0])}else if(" + v + "){" + m + "[a[0]]=" + d + "(a[1])}else{s=" + m + "[a[0]];if(typeof s==='string'){" + f + "+=s}else{s=" + d + "(a[1])}return s}}",
                n),
                this.dependencies = (i = {},
                i[c] = [f],
                i[u] = [f, g, s, m],
